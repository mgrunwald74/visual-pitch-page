    ...
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-800 font-sans">
      ...
      <section ref={addToRefs} className="relative py-20 md:py-32 bg-gradient-to-br from-brand-teal to-brand-green-dark text-white animated-element">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
      ...
      <section id="varianten" ref={addToRefs} className="py-16 md:py-24 bg-white animated-element">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start"><ListChecks className="w-5 h-5 text-brand-green mr-2 mt-1 flex-shrink-0" /> Erweitere dein Leistungsspektrum</li>
                <li className="flex items-start"><ListChecks className="w-5 h-5 text-brand-green mr-2 mt-1 flex-shrink-0" /> Ein Komplettpaket für Kunden aus einer Hand</li>
                <li className="flex items-start"><ListChecks className="w-5 h-5 text-brand-green mr-2 mt-1 flex-shrink-0" /> Höhere Stundensätze durch Zusatzservice</li>
                <li className="flex items-start"><ListChecks className="w-5 h-5 text-brand-green mr-2 mt-1 flex-shrink-0" /> Direkte Abrechnung über dich</li>
              </ul>
            </div>
            {/* Variant B Card */}
            <div
            ...
            >
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start"><ListChecks className="w-5 h-5 text-brand-blue mr-2 mt-1 flex-shrink-0" /> Weiterempfehlen und Provision erhalten</li>
                <li className="flex items-start"><ListChecks className="w-5 h-5 text-brand-blue mr-2 mt-1 flex-shrink-0" /> Kein zusätzlicher Aufwand vor Ort</li>
                <li className="flex items-start"><ListChecks className="w-5 h-5 text-brand-blue mr-2 mt-1 flex-shrink-0" /> Agentur übernimmt Beratung & Abrechnung</li>
                <li className="flex items-start"><ListChecks className="w-5 h-5 text-brand-blue mr-2 mt-1 flex-shrink-0" /> Regelmäßige Auszahlungen</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section id="vorteile" ref={addToRefs} className="py-16 md:py-24 bg-slate-100 animated-element">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-16 text-slate-800">
            Was hast du davon?
          </h2>
      ...
      <section id="kontakt" ref={addToRefs} className="py-20 md:py-32 bg-gradient-to-br from-brand-green-dark to-brand-teal text-white animated-element">
       <div className="absolute inset-0 bg-black opacity-20"></div>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Bereit durchzustarten?</h2>
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            Wähle deine Variante und steig in die Energiewende ein:<br/>
      ...
      {/* Footer */}
      <footer ref={addToRefs} className="py-8 bg-slate-800 text-slate-300 text-center animated-element">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <p>&copy; {new Date().getFullYear()} Münchner Energie Agentur</p>
          <p className="text-sm mt-1">Truderinger Str. 271B, 81825 München | <a href="mailto:kontakt@muenchnerenergieagentur.de" className="hover:text-brand-green-light transition-colors">kontakt@muenchnerenergieagentur.de</a></p>
        </div>
      </footer>
    </div>
  );
